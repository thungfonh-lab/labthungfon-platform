...
const SIG_HEAD_ROW = '<tr><th>วัน เดือน ปี</th><th>ชื่อ-สกุล</th><th>ตำแหน่ง</th><th>ประเภทเวร</th><th>เวลามา</th><th class="sig-col">ลายมือชื่อ</th><th>เวลากลับ</th><th class="sig-col">ลายมือชื่อ</th><th>หมาย<br>เหตุ</th></tr>';
...
function repOT(workload, year, month, scheduleAssign, N, settings) {
  ...
  let h = '<table class="rep-tbl rep-tbl-sig"><thead>' + reportHeaderRows(settings, year, month, 9) + SIG_HEAD_ROW + '</thead><tbody>';
  rows.forEach((row) => {
