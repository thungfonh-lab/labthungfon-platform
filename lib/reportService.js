...
const SIG_HEAD_ROW = '<tr><th>วัน เดือน ปี</th><th>ชื่อ-สกุล</th><th>ตำแหน่ง</th><th>ประเภทเวร</th><th>เวลามา</th><th class="sig-col">ลายมือชื่อ</th><th>เวลากลับ</th><th class="sig-col">ลายมือชื่อ</th></tr>';
...
function repOcClaim(pid, oncall, people, year, month) {
  ...
  let h = '<div style="text-align:center;font-size:15px;margin-bottom:10px">' +
